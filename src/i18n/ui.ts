...
export const ui = {
  es: {
    ...
    'creation.title': 'Creación',
    'creation.intro': 'Cómo se hace el trabajo.',
    'timeline.title': 'Línea de tiempo',
    'journal.mentions': 'En el diario',
    'project.tracks': 'Canciones',
    'project.story': 'Historia',
    'project.notes': 'Notas de producción',
    'project.credits': 'Créditos',
    'project.releases': 'Lanzamientos',
  ...
  en: {
    ...
    'creation.intro': 'How the work is made.',
    'timeline.title': 'Timeline',
    'journal.mentions': 'In the journal',
    'project.tracks': 'Tracks',
    'project.story': 'Story',
    'project.notes': 'Production notes',
